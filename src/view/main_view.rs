...
use crate::graphics::ellipse;
use crate::graphics::ellipse::circle;
use crate::graphics::text;
use crate::graphics::Transformed;
use crate::graphics::{clear, Line};
        ...
        self.gl.draw(args.viewport(), |c, gl| {
            ...
            if let Some(pivot) = windmill.get_pivot() {
                for point in points {
                    ...
                    ellipse(
                        point_color,
                        circle(point.get_point().x, point.get_point().y, 4.0),
                        c.transform,
                        gl,
                    );
                    ...
                    text(BLACK, 12, &count, glyphs, transform, gl).expect("Failed to draw text");
                }
            };
